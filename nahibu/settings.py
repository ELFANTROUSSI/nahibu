"""
Django settings for nahibu project.
...
SECRET_KEY = '585ysac-2r4ug9yq2y#=ph=u#(v*o%zcw!xcyt4me@jv$-&jrg'
...
WSGI_APPLICATION = 'nahibu.wsgi.application'
